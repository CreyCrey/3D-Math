...
public class PlayerData : ScriptableObject
{
    ...
    [HideInInspector] public float gravityScale; //Strength of the player's gravity as a multiplier of gravity (set in ProjectSettings).
                                                 //Also the value the player's rigidbody.gravityScale is set to.
    [Space(5)]
